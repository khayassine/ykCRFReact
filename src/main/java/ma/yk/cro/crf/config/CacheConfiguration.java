...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(ma.yk.cro.crf.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(ma.yk.cro.crf.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
