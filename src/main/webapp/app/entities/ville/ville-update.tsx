...
export interface IVilleUpdateState {
  isNew: boolean;
}

export class VilleUpdate extends React.Component<IVilleUpdateProps, IVilleUpdateState> {
  constructor(props) {
    super(props);
    this.state = {
  ...
  handleClose = () => {
    this.props.history.push('/entity/ville');
  };

  render() {
    const { villeEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="ykCrfApp.ville.home.createOrEditLabel">Create or edit a Ville</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : villeEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                ...
                <AvGroup>
                  ...
                  <AvField id="ville-titre" type="text" name="titre" />
                </AvGroup>
                <Button tag={Link} id="cancel-save" to="/entity/ville" replace color="info">
