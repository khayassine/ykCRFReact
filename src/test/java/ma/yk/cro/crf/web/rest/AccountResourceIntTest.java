package ma.yk.cro.crf.web.rest;

import ma.yk.cro.crf.YkCrfApp;
import ma.yk.cro.crf.config.Constants;
import ma.yk.cro.crf.domain.Authority;
import ma.yk.cro.crf.domain.User;
import ma.yk.cro.crf.repository.AuthorityRepository;
import ma.yk.cro.crf.repository.UserRepository;
import ma.yk.cro.crf.security.AuthoritiesConstants;
import ma.yk.cro.crf.service.MailService;
import ma.yk.cro.crf.service.UserService;
import ma.yk.cro.crf.service.dto.PasswordChangeDTO;
import ma.yk.cro.crf.service.dto.UserDTO;
import ma.yk.cro.crf.web.rest.errors.ExceptionTranslator;
import ma.yk.cro.crf.web.rest.vm.KeyAndPasswordVM;
import ma.yk.cro.crf.web.rest.vm.ManagedUserVM;
